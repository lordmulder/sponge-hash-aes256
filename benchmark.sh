...
readonly DATA_HASH=74ba46a12e0ed124916ecfccc4a8da426ac231aad9709030a280338e237f7c8a5329b6a5de126d8ee1979a6fa7b41d11776220492420ab328ff943fa7d2f4bdb
readonly CHCK_HASH=567d9cc3482cafc4e74885e19850b77b6366f329c3ca4976f28def0c23044c0eafbd9ad210602b06a2ef1ff65606eb55efc121edf47989e56c95ac60e88fc2c7
...
if [[ "${data_hash}" == "${DATA_HASH}" ]]; then
    ...
    echo "Error: File hash mismatch detected! (computed hash: ${tar_hash})"
    exit 1
fi
